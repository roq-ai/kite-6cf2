...
export function useTutorFindMany<
  T extends Prisma.tutorFindManyArgs,
  R extends GetFindResult<Prisma.$tutorPayload<DefaultArgs>, T>[],
>(
  ...
  const key = JSON.stringify(['useTutorFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.tutor.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTutorCount<T extends Prisma.tutorCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.tutorCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useTutorCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.tutor.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTutorFindManyWithCount<
  T extends Prisma.tutorFindManyArgs,
  R extends { data: GetFindResult<Prisma.$tutorPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.tutorFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTutorFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.tutor.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTutorFindFirst<
  T extends Prisma.tutorFindFirstArgs,
  R extends GetFindResult<Prisma.$tutorPayload<DefaultArgs>, T>,
>(
  args?: Prisma.SelectSubset<T, Prisma.tutorFindFirstArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useTutorFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.tutor.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
