  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Kite: Revolutionizing Tutoring in the Information Age. Our Smart Tutoring system leverages AI to transform your teaching materials into interactive, efficient learning experiences. For a teaching moment that truly shines, join us today."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1621356986575-05811227a42e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0dXRvcmluZ3xlbnwwfHx8fDE2OTk2NDgwNDN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@neonbrand?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Kenny Eliason`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Kite: Revolutionizing Tutoring in the Information Age. Our Smart Tutoring system leverages AI to transform your teaching materials into interactive, efficient learning experiences. For a teaching moment that truly shines, join us today.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Tutor" type="tutor" abilities={appConfig.ownerAbilities} />
