...
import { useTutorFindFirst, useRoqClient } from 'lib/roq';
...
function TutorViewPage() {
  ...
  const { data, error, isLoading } = useTutorFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('tutor', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/tutors/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="tutor" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
