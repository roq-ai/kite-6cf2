...
export namespace Prisma {
  ...
  */
  ...
  export type TutorCountOutputTypeSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    user?: boolean | TutorCountOutputTypeCountUserArgs;
  };
   ...
   * TutorCountOutputType without action
   */
  export type TutorCountOutputTypeCountUserArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
  ...
  export type tutorSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<
    {
      ...
      created_at?: boolean;
      updated_at?: boolean;
      user?: boolean | tutor$userArgs<ExtArgs>;
  ...
  type tutorGetPayload<S extends boolean | null | undefined | tutorDefaultArgs> = $Result.GetResult<
    Prisma.$tutorPayload,
    S
  >;

  type tutorCountArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = Omit<
    tutorFindManyArgs,
  ...
  export interface tutorDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
     ...
     * })
     **/
    aggregate<T extends TutorAggregateArgs>(
      args: Subset<T, TutorAggregateArgs>,
    ): Prisma.PrismaPromise<GetTutorAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, tutorGroupByArgs, OrderByArg> & InputErrors,
    ): {} extends InputErrors ? GetTutorGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
   ...
   */
  export interface Prisma__tutorClient<
    T,
    Null = never,
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > extends Prisma.PrismaPromise<T> {
    ...
    user<T extends tutor$userArgs<ExtArgs> = {}>(
      args?: Subset<T, tutor$userArgs<ExtArgs>>,
  ...
  interface tutorFieldRefs {
    ...
    readonly updated_at: FieldRef<'tutor', 'DateTime'>;
  }
   ...
   * tutor.user
   */
  export type tutor$userArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    tutor<T extends user$tutorArgs<ExtArgs> = {}>(
      args?: Subset<T, user$tutorArgs<ExtArgs>>,
    ): Prisma__tutorClient<
      $Result.GetResult<Prisma.$tutorPayload<ExtArgs>, T, 'findUniqueOrThrow'> | null,
      null,
      ExtArgs
    >;
  ...
  interface userFieldRefs {
    ...
    readonly tutor_id: FieldRef<'user', 'String'>;
  ...
  export type tutorWhereInput = {
    ...
    updated_at?: DateTimeFilter<'tutor'> | Date | string;
  ...
  export type tutorScalarWhereWithAggregatesInput = {
    ...
    id?: UuidWithAggregatesFilter<'tutor'> | string;
    ...
    updated_at?: DateTimeWithAggregatesFilter<'tutor'> | Date | string;
  };
  ...
  export type userWhereInput = {
    ...
    tutor_id?: UuidNullableFilter<'user'> | string | null;
  ...
  export type userScalarWhereWithAggregatesInput = {
    ...
    tutor_id?: UuidNullableWithAggregatesFilter<'user'> | string | null;
  ...
  export type tutorCreateInput = {
    ...
    user?: userCreateNestedManyWithoutTutorInput;
  };
  ...
  export type tutorUncheckedCreateInput = {
    ...
    created_at?: Date | string;
    updated_at?: Date | string;
    user?: userUncheckedCreateNestedManyWithoutTutorInput;
  };
  ...
  export type tutorUpdateInput = {
    ...
    user?: userUpdateManyWithoutTutorNestedInput;
  };
  ...
  export type tutorUncheckedUpdateInput = {
    ...
    created_at?: DateTimeFieldUpdateOperationsInput | Date | string;
    updated_at?: DateTimeFieldUpdateOperationsInput | Date | string;
    user?: userUncheckedUpdateManyWithoutTutorNestedInput;
  };
  ...
  export type userUncheckedUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string;
    email?: StringFieldUpdateOperationsInput | string;
    tutor_id?: NullableStringFieldUpdateOperationsInput | string | null;
    first_name?: NullableStringFieldUpdateOperationsInput | string | null;
    last_name?: NullableStringFieldUpdateOperationsInput | string | null;
    locale?: NullableStringFieldUpdateOperationsInput | string | null;
    timezone?: NullableStringFieldUpdateOperationsInput | string | null;
  ...
  export type userCreateNestedManyWithoutTutorInput = {
    create?:
      | XOR<userCreateWithoutTutorInput, userUncheckedCreateWithoutTutorInput>
      | userCreateWithoutTutorInput[]
      | userUncheckedCreateWithoutTutorInput[];
    connectOrCreate?: userCreateOrConnectWithoutTutorInput | userCreateOrConnectWithoutTutorInput[];
    createMany?: userCreateManyTutorInputEnvelope;
    connect?: userWhereUniqueInput | userWhereUniqueInput[];
  };

  export type userUncheckedCreateNestedManyWithoutTutorInput = {
    create?:
      | XOR<userCreateWithoutTutorInput, userUncheckedCreateWithoutTutorInput>
      | userCreateWithoutTutorInput[]
      | userUncheckedCreateWithoutTutorInput[];
  ...
  export type userUpdateManyWithoutTutorNestedInput = {
    create?:
      | XOR<userCreateWithoutTutorInput, userUncheckedCreateWithoutTutorInput>
      | userCreateWithoutTutorInput[]
      | userUncheckedCreateWithoutTutorInput[];
    connectOrCreate?: userCreateOrConnectWithoutTutorInput | userCreateOrConnectWithoutTutorInput[];
    upsert?: userUpsertWithWhereUniqueWithoutTutorInput | userUpsertWithWhereUniqueWithoutTutorInput[];
    createMany?: userCreateManyTutorInputEnvelope;
    set?: userWhereUniqueInput | userWhereUniqueInput[];
    disconnect?: userWhereUniqueInput | userWhereUniqueInput[];
    delete?: userWhereUniqueInput | userWhereUniqueInput[];
    connect?: userWhereUniqueInput | userWhereUniqueInput[];
    update?: userUpdateWithWhereUniqueWithoutTutorInput | userUpdateWithWhereUniqueWithoutTutorInput[];
    updateMany?: userUpdateManyWithWhereWithoutTutorInput | userUpdateManyWithWhereWithoutTutorInput[];
    deleteMany?: userScalarWhereInput | userScalarWhereInput[];
  };

  export type userUncheckedUpdateManyWithoutTutorNestedInput = {
    create?:
      | XOR<userCreateWithoutTutorInput, userUncheckedCreateWithoutTutorInput>
      | userCreateWithoutTutorInput[]
      | userUncheckedCreateWithoutTutorInput[];
  ...
  export type tutorUpdateOneWithoutUserNestedInput = {
    ...
    connect?: tutorWhereUniqueInput;
    update?: XOR<
      XOR<tutorUpdateToOneWithWhereWithoutUserInput, tutorUpdateWithoutUserInput>,
      tutorUncheckedUpdateWithoutUserInput
    >;
  };
  ...
  export type userCreateManyTutorInputEnvelope = {
    data: userCreateManyTutorInput | userCreateManyTutorInput[];
    skipDuplicates?: boolean;
  };

  export type userUpsertWithWhereUniqueWithoutTutorInput = {
    where: userWhereUniqueInput;
    update: XOR<userUpdateWithoutTutorInput, userUncheckedUpdateWithoutTutorInput>;
    create: XOR<userCreateWithoutTutorInput, userUncheckedCreateWithoutTutorInput>;
  };

  export type userUpdateWithWhereUniqueWithoutTutorInput = {
    where: userWhereUniqueInput;
    data: XOR<userUpdateWithoutTutorInput, userUncheckedUpdateWithoutTutorInput>;
  };

  export type userUpdateManyWithWhereWithoutTutorInput = {
    where: userScalarWhereInput;
    data: XOR<userUpdateManyMutationInput, userUncheckedUpdateManyWithoutTutorInput>;
  };
  ...
  export type userCreateManyTutorInput = {
    id?: string;
    email: string;
    first_name?: string | null;
    last_name?: string | null;
  ...
  export type userUncheckedUpdateManyWithoutTutorInput = {
    id?: StringFieldUpdateOperationsInput | string;
    email?: StringFieldUpdateOperationsInput | string;
    first_name?: NullableStringFieldUpdateOperationsInput | string | null;
    last_name?: NullableStringFieldUpdateOperationsInput | string | null;
   ...
   */
  export type TutorCountOutputTypeArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
    TutorCountOutputTypeDefaultArgs<ExtArgs>;
  /**
